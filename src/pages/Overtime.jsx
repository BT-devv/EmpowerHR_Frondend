  ...
  return (
    <div className="flex flex-col bg-[#F5F6FA] w-full h-full relative">
      <div className="bg-[#FFFFFF] ml-[3%] mt-[2%] rounded-[10px] w-[77%] text-left shadow-[0px_1px_3px_rgba(0,0,0,0.2)]">
        ...
        <div className="flex ml-[5%] space-x-[28%]">
          <div className="mt-[3%]">
            <p>From</p>
            <input
              type="text"
              className="border-gray-200 rounded-[5px] border-[2px] w-[220%] h-[50px] mt-[5px] pl-[10px] hover:border-[#2EB67D] hover:border-2 focus:border-[#2EB67D] focus:outline-none focus:border-2 placeholder:text-[#B8BDC5] placeholder:text-[14px] placeholder:font-light"
              // value={firstName}
              placeholder="Select Manager"
              // onChange={(e) => {
              //   setFirstName(e.target.value);
